public class Exercise2 {
	...
	public static void main(String[] args){
		...
		System.out.println("foo with 100 done");
			...
			System.out.println("caught Aexception  for foo 100" + e);
		}
		try{
			foo(23);
			...
			System.out.println("caught Aexception  for foo 23" + e);
		}
		try{
			foo(15);
			...
			System.out.println("caught Aexception  for foo 15" + e);
		}
	...
	public static void foo(int x) throws AException {
		...
		try{
			...
			System.out.println("BException caught" + e);
		}
	...
	public static void bar(int y) throws BException{
		if( y % 3 == 0){
			System.out.println("BEception thrown in bar");
