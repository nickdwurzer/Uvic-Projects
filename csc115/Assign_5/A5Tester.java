...
public class A5Tester {
	...
	public static void testDuplicates() {
		...
		pq.insert(4);
		pq.insert(4);
		//System.out.println("q after insert 4 1 4 4: " + pq);
		pq.insert(0);
		pq.insert(5);
		pq.insert(0);
		pq.insert(5);
		System.out.println("q after insert 0505:" + pq);

		result = ((Integer)pq.removeMin()).intValue();
		//System.out.println(result + "pq:" + pq);
	...
	public static void testEmergencyRoom() {
		...
		nextP = e1.nextPatient();
		System.out.println("This is where im at");
